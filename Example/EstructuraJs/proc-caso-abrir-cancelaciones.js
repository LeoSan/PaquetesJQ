var pantallaAbrirCancelaciones = {
    msjEspere:"<div id='msjEspere' class='alert alert-warning' role='alert'><span class='glyphicon glyphicon-exclamation-sign' aria-hidden='true'></span><span class='sr-only'>Mensaje : </span> Por favor espere, se est&aacute;n agregando las cuentas a la bit&aacute;cora.</div>",
    ...
    init : function() {
      ...
      //  pantallaAbrirCancelaciones.btnAbrirCaso();
    ...
    procesoGuardar:function () {
               ...
               // var userid = $("#userid").html();
                var inpUsuarioCaso = $("#inpUsuarioCaso").val();
                var inpUsuarioAsigna = $("#inpUsuarioAsigna").val();

                $.ajax({
                    url: baseUrl + '/gastos/comprobacionfactura/proceso-abrir-caso-cancelado',
                    type: 'POST',
                    data: {NumCaso : NumCaso, inpNota:inpNota, userid:inpUsuarioCaso, inpUsuarioAsigna:inpUsuarioAsigna },
                    dataType: 'html',
                    beforeSend: function () {
                        $('#divHistoricoBitacora').html(pantallaAbrirCancelaciones.msjEspere);
                    },
